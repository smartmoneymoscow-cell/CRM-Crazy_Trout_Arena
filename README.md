...
- 🎯 **Фильтры** — по уровню клиента (Премиум / Стандарт / Базовый)
- 👤 **Профили клиентов** — баллы лояльности, история посещений, статистика улова
- 🏅 **Уровни** — Серебряный рыболов, система баллов и прогресса
- 📅 **Расписание** — бронирования по секторам и времени

### Отчёт и финансы
- 📊 **Финансовый дашборд** — выручка со спарклайном, маржинальная прибыль, переменные расходы с прогресс-барами
- 📈 **KPI-карточки** — средний чек, LT/LTV, клиенты, рейтинг ★, улов
- 📉 **Динамика выручки** — выручка/маржа/расходы, переключатель месяц/неделя
- 🥧 **Структура выручки** — кольцевая диаграмма (маржинальная прибыль vs расходы)
- 🐟 **Декомпозиция продаж** — круговая диаграмма по 5 породам + вход по тарифам
- 💳 **Оплата/тарифы** — столбчатая диаграмма по способам оплаты, кольцевая по тарифам
- 📋 **Статистика улова** — таблицы с градиентами, доля рыбы, маржинальность
- 🔍 **Фильтры отчёта** — период, календарь, иконки (₽ 👥 🐟)

### Чеки (история)
- 🧾 **Лента чеков** — поиск, фильтры (Период/Тип) с календарём и range-выбором
...
|--------|------|-----------|
| **v1.3.69** | 16.07.2026 | Финансовый экран: KPI (средний чек, LT/LTV, клиенты, рейтинг, улов), динамика выручки/маржи/расходы, структура выручки, оплата/тарифы |
