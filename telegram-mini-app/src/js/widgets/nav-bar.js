...
const TABS = [
  { id: 'pond',    icon: 'map',        label: 'Карта' },
  { id: 'receipt', icon: 'receipt',     label: 'Чек' },
  { id: 'checks',  icon: 'receiptLong', label: 'Чеки' },
  { id: 'report',  icon: 'chart',       label: 'Отчёты' },
  { id: 'profile', icon: 'person',      label: 'Профиль' },
];

// Material Design outlined icons (24x24, viewBox 0 0 24 24)
const ICON_PATHS = {
  ...
  receiptLong: 'M19.5 3.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2v20l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5zM19 19.09H5V4.91h14v14.18zM6 15h12v2H6zm0-4h12v2H6zm0-4h12v2H6z',
  chart: 'M3.5 18.49l6-6.01 4 4L22 6.92l-1.41-1.41-7.09 7.97-4-4L2 16.99z',
  person: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4zm0-6c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm0 8.55c2.25.39 4.58.97 5.73 1.45H6.27c1.15-.48 3.48-1.06 5.73-1.45zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z',
};
...
function renderNav() {
  ...
  navContainer.innerHTML = TABS.map(tab => `
    <button class="nav-item ${tab.id === activeTab ? 'active' : ''}" data-tab="${tab.id}">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="${ICON_PATHS[tab.icon]}"/></svg>
